  ...
  return (
    <div className='container max-w-3xl py-6'>
      <div className='flex items-center justify-between mb-6'>
        <div>
          <h1 className='text-2xl font-bold tracking-tight'>Sale Agreement Details</h1>
          <p className='text-muted-foreground'>View and manage sale agreement information</p>
        </div>
