  ...
  return (
    <Layout>
      <div className="bg-background flex flex-col items-center justify-start">
        <section className="container flex flex-col sm:flex-row items-center justify-evenly my-20">
          <div className="sm:w-2/5 flex flex-col justify-center py-10">
            ...
            <p className="mt-6 text-lg sm:text-xl text-muted-foreground text-justify font-secondary leading-6 tracking-tight">
              A.N. Zeph & Associates is a recognized and committed law firm that
              is committed to you outstanding legal services that are
              specifically designed to fit your unique needs. We work to provide
              our customers with individualized and successful solutions using
              our team of skilled lawyers and their in-depth knowledge of many
        ...
        <section className="bg-accent w-full rounded-lg">
          <div className="container flex flex-col sm:flex-row justify-evenly py-20 sm:py-40">
            ...
            <div className="sm:w-2/5 flex flex-col justify-center p-10">
              ...
              <p className="mt-6 text-lg sm:text-xl text-justify font-secondary leading-6 text-muted-foreground tracking-tight">
                We are committed to providing our clients with high-quality
                legal representation and personalized attention throughout every
...
function ServiceCard({ icon, title, description }: ServiceCardProps) {
  return (
    <div className="bg-primary rounded-lg flex flex-col gap-5  hover:scale-101 transition ease-in  p-5 sm:p-10 hover:shadow-lg">
      <div className="flex items-center justify-start">{icon}</div>
      <h3 className="text-3xl  font-heading font-bold">{title}</h3>
